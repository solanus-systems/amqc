...
class MQTT_base:
    ...
    def __init__(self, config, logger=logging.getLogger("amqc")):
        self._logger = logger
    ...
    def _connect_socket(self):
        ...
        self._logger.debug(f"sock#{self._sock.fileno()}")
    ...
    async def connect(self, clean=True):
        ...
        if self._lw_topic:
            sz += 2 + len(self._lw_topic) + 2 + len(self._lw_msg) + 1
        ...
        # This is needed for following reads to work correctly
